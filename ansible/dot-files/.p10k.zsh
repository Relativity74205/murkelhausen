# Generated by Powerlevel10k configuration wizard on 2022-08-03 at 23:26 CEST.
...
# dotted, full frame, sparse, concise, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    taskwarrior             # taskwarrior tasks count (https://taskwarrior.org/)
    # time                  # current time
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  # If the tracked tasks is longer than 24 characters, truncate and append "…".
  # Tip: To always display tasks without truncation, delete the following parameter.
  # Tip: To hide tasks names and display just the icon when time tracking is enabled, set the
  ...
  #
  # - P9K_TASKWARRIOR_PENDING_COUNT   The number of pending tasks: `tasks +PENDING count`.
  # - P9K_TASKWARRIOR_OVERDUE_COUNT   The number of overdue tasks: `tasks +OVERDUE count`.
  #
